...
#Defining a function for improving the datasets for Polynomial regression and regularizing the model by ElasticNet regularization:
def get_preds_ridge( x1, x2, alpha ):
    model = Pipeline( [ ( 'poly_feats', PolynomialFeatures( degree = 16 ) ), ( 'elasticnet', ElasticNet( alpha = alpha, l1_ratio = 0.5 ) ) ] )
    model.fit( x1, x2 )
